...
import static queueCoordinator.QueueCoordinatorImpl.ActionEnum.*;
...
public class QueueCoordinatorImpl<T> implements QueueCoordinator<T> {
    ...
    public static void main(String[] args) {
        QueueCoordinator<Integer> queueCoordinator = new QueueCoordinatorImpl<>();
     ExecutorService executorService= Executors.newFixedThreadPool(9);
        for(int i=1;i<100;i++){
            Integer id=i;
            executorService.submit(()->{

                boolean flag= queueCoordinator.enQueue(1);
                queueCoordinator.deQueue(1);
